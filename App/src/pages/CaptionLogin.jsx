...
const CaptionLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      console.log('%c[PrimeRide Captain Login] JSON Output:', 'color: #f59e0b; font-weight: bold; font-size: 14px;');
  ...
  return (
    <div className="h-full w-full flex flex-col justify-between bg-black select-none overflow-y-auto font-['Outfit',sans-serif] relative">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-6 max-w-sm w-full mx-auto z-10">
        <div className="mb-6">
          <div className="inline-flex items-center gap-1.5 bg-neutral-900/90 text-amber-400 text-xs font-semibold px-3 py-1 rounded-full border border-amber-500/20 mb-3">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
            Captain Portal
          </div>
          <h2 className="text-white text-3xl font-bold tracking-tight">Driver Login</h2>
          <p className="text-neutral-400 text-sm mt-1">
            Access your driver console & active ride dispatching.
          </p>
        </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="captain@primeride.com"
                className={`w-full pl-10 pr-4 py-3 bg-neutral-900/90 text-white rounded-xl border text-sm outline-none transition-all duration-200 placeholder:text-neutral-500 ${
                  errors.email
                    ? 'border-red-500/80 focus:border-red-400 focus:ring-2 focus:ring-red-500/20'
                    : 'border-neutral-800 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20'
      ...
      <div className="w-full pb-6 px-6 text-center text-xs text-neutral-500 z-10 flex flex-col gap-1.5">
        <p>
          ...
          <Link to="/captain-signup" className="text-amber-400 font-medium hover:underline">
            Captain Sign Up
          </Link>
        </p>
        <p>
